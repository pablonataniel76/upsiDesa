...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>TRABAJOPOLIS</b></a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">FORMULARIO DE REGISTRO PARA CANDIDATOS</p>
    ...
    <form action="../../index.html" method="post">
      ...
      <div class="form-group has-feedback">
            <input type="number" class="form-control" placeholder="Pretensión Salarial (Bs)">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <select class="form-control select2" style="width: 100%;">
                        <option selected="selected">Seleccionar Profesión u Ocupación</option>
                        <option>Profesion1</option>
                        <option>Profesion2</option>
                        <option>Prodesion3</option>                                  
                    </select>
                    </div>
      <div class="row">
        <div class="col-xs-12">
    ...
    <a href="" class="text-center">¿Eres una empresa en busca de personal?</a>
    <br>
